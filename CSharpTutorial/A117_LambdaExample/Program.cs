...
namespace A117_LambdaExample
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int[] numbers = { 2, 3, 4, 5 };
            var squaredNumbers = numbers.Select((x) => { return x * x; });
            Console.WriteLine(string.Join(" ", squaredNumbers));

            Action line = () => { Console.WriteLine(); };
            line();

            CalcMethod add = (a, b) => { return a + b; };
            CalcMethod subtract = (a, b) => { return a - b; };
            ...
            Console.WriteLine("{0}은 {1}.", s1.Name, isTeen(s2) ? "성인입니다" : "성인이 아닙니다");
        }
