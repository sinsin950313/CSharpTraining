...
namespace A065_ClassAndStruct
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            cDay.month = 11;
            cDay.day = 22;
            Console.WriteLine("sDay : {0}/{1}/{2}", cDay.year, cDay.month, cDay.day);

            DateStruct sDay2 = new DateStruct();
            Console.WriteLine("sDay1 : {0}/{1}/{2}", sDay2.year, sDay2.month, sDay2.day);
            ...
            Console.WriteLine("s2 : {0}/{1}/{2}", s2.year, s2.month, s2.day);
